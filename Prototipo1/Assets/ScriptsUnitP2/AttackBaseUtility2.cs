...
public class AttackBaseUtility2 : MonoBehaviour {
    ...
    IEnumerator SetDirectionAttackBase()
    {
        //SetRange();
        //tank destra
        if (Input.GetKeyDown(KeyCode.DownArrow) && isAttack == true && isAttUp == true && utilityP2.isUnitEnemie == true)
        {
        ...
        //tanke sinistra
        if (Input.GetKeyDown(KeyCode.UpArrow) && isAttack == true && isAttDown == true && utilityP2.isUnitEnemie == true)
        {
        ...
        //tank sopra
        if (Input.GetKeyDown(KeyCode.RightArrow) && isAttack == true && isAttLeft == true && utilityP2.isUnitEnemie == true)
        {
        ...
        // healer sotto
        if (Input.GetKeyDown(KeyCode.LeftArrow) && isAttack == true && isAttRight == true && utilityP2.isUnitEnemie == true)
        {
