...
public class AttackBaseHealer2 : MonoBehaviour {
    ...
    {
        if (Input.GetKeyDown(attackButton) && turn.isTurn == false && isAttack == false && selectionP2.isActiveHealerP2 == true)
        {
            isAttack = true;
        ...
        else if (Input.GetKeyDown(attackButton) && turn.isTurn == false && isAttack == true && selectionP2.isActiveHealerP2 == true)
        {
            isAttack = false;
    ...
    IEnumerator SetDirectionAttackBase()
    {
        //SetRange();
        //tank destra
        if (Input.GetKeyDown(KeyCode.Space) && isAttack == true && healerP2.isUnitEnemie == true)
        {
